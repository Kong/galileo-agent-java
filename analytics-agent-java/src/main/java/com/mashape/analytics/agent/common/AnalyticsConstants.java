...
public class AnalyticsConstants {
	...
	public static final String SOCKET_POOL_SIZE_MIN = "minPoolSize";
	public static final String SOCKET_POOL_SIZE_MAX = "maxPoolSize";
	public static final String SOCKET_POOL_UPDATE_INTERVAL = "poolUpdateInterval";
